...
export type PlatformExecutionOperation = "CLICK" | "SET_MEDIA" | "FILL_CAPTION" | "FILL_TITLE" | "ENSURE_BOOLEAN" | "SELECT_ENUM" | "ANSWER_AUDIENCE" | "FINAL_BOUNDARY";
export interface PlatformExecutionAction { stepKey:string; operation:PlatformExecutionOperation; locators:readonly UiLocator[]; settingKey?:"madeForKids"|"visibility"|"commentsEnabled"|"duetEnabled"|"stitchEnabled"|"shareToFeed"|"crosspostFacebook"|"trialMode"; expectedValue?:string|boolean; /** True when the setting was never demanded by the operator: the platform default stands and an unprovable control is not a failure. */ operatorDemanded?:boolean; }
