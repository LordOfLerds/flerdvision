...
import { runAcceptanceCli } from "./acceptance-cli.js";
...
async function main(): Promise<void> {
  ...
  if (command === "acceptance") {
    await runAcceptanceCli(argv, specPath, releaseSha(argv), { env: process.env });
    return;
  }
